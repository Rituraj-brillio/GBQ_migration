...
os.environ["GOOGLE_API_KEY"] = "AIzaSyCIImnw1jG5lFiOygH20Zo9w-MEsj5s0x0"  # Replace with your actual API key
...
def create_prompt():
    prompt = f"""
    You are an AI that converts natural language questions into BigQuery SQL queries. 
    Your goal is to understand the user's intent and generate a valid BigQuery SQL query.
    dont include \n characeters in the response.
